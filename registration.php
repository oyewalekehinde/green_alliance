...
<style>
  ...
  .modal {
    min-width: 600px;
    background-color: #F1F8F4; /* light green */
    padding: 64px 40px;
    border-radius: 16px;
  }
  .form-group {
...
<div class="modal">
    ...
    <form id="registrationForm" method="post" action="registration.php">
        ...
        <input placeholder="Enter your first name" type="text" id="first_name" name="first_name" required title="Please enter a valid name">
        </div>
        <div class="form-group">
        <label for="last_name">Last Name</label>
        <input placeholder="Enter your last name" type="text" id="last_name" name="last_name" required title="Please enter a valid name">
        </div>
        <div class="form-group">
...
<?php
      ...
      if (isset($_POST["submit"])) {
        ...
        $email = $_POST["email"];
        $pass = $_POST["password"];
        $inert_query = "INSERT INTO `registration` (`id`, `first_name`, `last_name`, `email`, `password`, `role`) VALUES (NULL, '$first_name','$last_name','$email','$pass','admin')";
