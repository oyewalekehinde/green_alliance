        ...
        <div style="width: 100%;">
            <div style="margin: 20px 40px">
                <div style="display: flex; justify-content: space-between;">
                    <div>
                        <p style="color: #81848F; font-size: 12px; margin: 0 0 5px;">Pages <span style="color: #242428;">/ Dashboard</span></p>
                        <p style="color: #2D3748; font-size: 14px; margin: 0;">Resident Management</p>
                    </div>
                    <div style="border-radius: 50%; width: 30px; height: 30px; background: white; display: flex; align-items: center; justify-content: center;">
                        <p class="font-size: 20px; font-weight: 600;">KO</p>
                    </div>
                </div>
        ...
        window.onload = function () {
            ...
            var donutchart = new CanvasJS.Chart("donutchartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: [
                        { y: 67, label: "Inbox (67)", color: "#18B171" },
                        { y: 28, label: "Archives", color: "#38CB89" },
                        { y: 10, label: "Labels", color: "#AAF0CA" },
                    ]
                }]
            });
            donutchart.render();
