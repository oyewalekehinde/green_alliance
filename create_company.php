...
<div class="modal">
    ...
    <form id="registrationForm" method="post" action="company_registration.php">
        <div class="form-group">
        <label for="company_name">Company Name</label>
        <input placeholder="Enter the company name" type="text" id="company_name" name="company_name" required title="Please enter a valid name">
        </div>
        <div class="form-group">
        <label for="address">Address </label>
        <input placeholder="Enter your last name" type="text" id="address" name="address" required title="Please enter a valid address">
        </div>
        <div class="form-group">
